        ...
        <div class="col-xs-12">
          <div class="box box-primary">
            <div class="box-header">
              ...
              <?php } ?>
              <span style="float:right;"><a href="<?= site_url('Organizations/create');?>"><button class="btn btn-sm btn-primary"><i class="glyphicon glyphicon-plus"></i>&nbsp;Create</button></a></span>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                foreach($OrganizationsData as $data) { ?>
                  <tr>
                    <td><?= $sr;?></td>
                    <td><?= $data->name?></td>                                       
                    <td><?php echo anchor(site_url('Organizations/update/'.$data->org_uuid),'<button class="btn btn-xs btn-warning"><i class="glyphicon glyphicon-edit"></i>&nbsp;Edit</button>');         ?>
                    </td>
                  </tr>
                <?php $sr++; } ?>
                </tbody>
