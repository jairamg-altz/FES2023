...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Blog Resourses List</li>
      </ol>
    </section>
              ...
              <table id="example1" class="table table-bordered table-striped">
                <thead>
                  <tr>
                    ...
                    <th>Reply</th>
                    <th>Resourse URL</th>
                    <th>Resourse Comment</th>
                  </tr>
                </thead>
                <tbody>
                <?php 
                 $sr=1;
                foreach($BlogResoursesData as $data) {
                 ?>
                  <tr>
                    <td><?= $sr;?></td>
                    <td><?= ucfirst($data->blog_title);?></td>
                    <td><?= ucfirst($data->blog_answer_body);?></td>
                    <td><?= $data->blog_resources_resource_url;?></td>
                    <td><?= $data->blog_resources_comment ?></td>                    
                  </tr>
                <?php $sr++; } ?>
                </tbody>
              </table>
