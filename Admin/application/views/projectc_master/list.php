        ...
        <div class="col-xs-12">
          <div class="box box-primary">
            <div class="box-header">
              ...
              <?php } ?>
              <span style="float:right;"><a href="<?= site_url('ProjectCMaster/create');?>"><button class="btn btn-sm btn-primary"><i class="glyphicon glyphicon-plus"></i>&nbsp;Create</button></a></span>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <?php $sr=1; foreach($ProjectColumnsData as $data) { ?>
                  <tr>
                    ...
                    <td>                     
                      <?php echo anchor(site_url('ProjectCMaster/update/'.$data->project_column_master_id),'<button class="btn btn-xs btn-warning"><i class="glyphicon glyphicon-edit"></i>&nbsp;Edit</button>');?>
                    </td>
                  </tr>
                <?php $sr++; } ?>
                </tbody>
