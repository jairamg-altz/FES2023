<?php $this->load->view('includes/header'); $this->load->view('includes/left_panel'); ?>
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?= site_url('Dforums/index');?>">Discussion forum List</a></li>
          ...
          <div class="row">
            ...
            <div class="col-md-6">
	            ...
	            <div class="form-group">
	                <label for="title">Discussion forum <span class="red">*</span></label>
	                <input type="text" class="form-control" id="text_msg" name="text_msg" value="<?= $text_msg;?>" placeholder="Enter discussion forum">
	                <span style="color:red" id="errTitle"><?= form_error('text_msg');?></span>
	            </div>
	            <div class="form-group">
                  <label for="title">Subject <span class="red">*</span></label>
                  <input type="text" class="form-control" id="subject" name="subject" value="<?= $subject;?>" placeholder="Enter subject">
                  <span style="color:red" id="errTitle"><?= form_error('subject');?></span>
              </div> 
              <div class="form-group">
