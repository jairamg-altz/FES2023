          ...
          <div class="row">
            ...
            <div class="col-md-6">
	            ...
	            <div class="form-group">
	                ...
	                <input type="text" class="form-control" id="blog_title" name="blog_title" value="<?= $blog_title;?>" placeholder="Enter blog title" required>
	                <span style="color:red" id="errTitle"><?= form_error('blog_title');?></span>
	            </div>
	            <div class="form-group">
                  <label for="title">Blog Body <span class="red">*</span></label>
                  <input type="text" class="form-control" id="blog_body" name="blog_body" value="<?= $blog_body;?>" placeholder="Enter blog body" required>
                  <span style="color:red" id="err"><?= form_error('blog_body');?></span>
              </div> 
              <div class="form-group">
                  <label for="title">Blog Question <span class="red">*</span></label>
                  <input type="text" class="form-control" id="blog_is_question" name="blog_is_question" placeholder="Enter blog question" value="<?= $blog_is_question;?>" required>
            ...
            <div class="col-md-12">
            	...
            	<a href="<?= site_url('Blogs/index');?>"><button class="btn btn-danger" type="button">Cancel</button></a>
            </div>
        </div>
      	</form>    
       </div>
