        ...
        <div class="col-xs-12">
          <div class="box box-primary">
            <div class="box-header">
              ...
              <?php } ?>
              <span style="float:right;"><a href="<?= site_url('Licenses/create');?>"><button class="btn btn-sm btn-primary"><i class="glyphicon glyphicon-plus"></i>&nbsp;Create</button></a></span>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                <?php $sr=1; foreach($LicensesData as $data) { ?>
                  <tr>
                    <td><?= $sr;?></td>
                    <td><?= $data->data_license?></td>                                 
                    <td><?php echo anchor(site_url('Licenses/update/'.$data->data_licenses_id),'<button class="btn btn-xs btn-warning"><i class="glyphicon glyphicon-edit"></i>&nbsp;Edit</button>'); ?>
                    </td>
                  </tr>
                <?php $sr++; } ?>
                </tbody>
