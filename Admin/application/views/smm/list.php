          ...
          <div class="box box-primary">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                <?php $sr=1; foreach($SpMastersData as $data) {  ?>
                  <tr>
                    <td><?= $sr;?></td>
                    <td><?= ucfirst($data->species_master_name);?></td>                                       
                    <td>                      
                      <?php 
                            echo anchor(site_url('SpMasters/update/'.$data->species_master_id),'<button class="btn btn-xs btn-warning"><i class="glyphicon glyphicon-edit"></i>&nbsp;Edit</button>'); 
                            echo '|';
                            echo anchor(site_url('SpMasters/delete/'.$data->species_master_id),'<button class="btn btn-xs btn-danger"><i class="glyphicon glyphicon-trash"></i>&nbsp;Delete</button>','onclick="javasciprt: return confirm(\'Are You Sure ?\')"');                       
                      ?>
                    </td>
                  </tr>
                <?php $sr++; } ?>
