<?php $this->load->view('includes/header');$this->load->view('includes/left_panel');?>
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?= site_url('ProjectColumns/index');?>">Project Column List</a></li>
      ...
      <div class="box box-primary">
        <div class="box-header">
          <div class="box-tools pull-right">
            <a href="<?= site_url('ProjectColumns/index');?>">
        ...
        <div class="box-body">
          <div class="row">
            ...
            <div class="col-md-12">
            	<input type="hidden" name="project_column_id" value="<?= $project_column_id?>">
            	<button class="btn btn-primary" type="submit" onclick="return checkValidates();"><?= $button;?></button>
            	<a href="<?= site_url('ProjectColumns/index');?>"><button class="btn btn-danger" type="button">Cancel</button></a>
            </div>
        </div>
      	</form>
