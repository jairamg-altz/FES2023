...
many people. Record your project checklist with IBIS. </b></p>
    </div>
</section>
<div class="p-3">
    <div class="row">
    <div class="col-md-12 text-end">
            <button class="btn btn-outline-dark btn-lg" data-bs-target="#addChecklistModal" data-bs-toggle="modal" onclick="initMapClickForChecklistCapture();">Add Project Checklist</button>
        </div>
        ...
        <div class="col-lg-3 col-md-6 d-flex align">
            <div class="member w-100">
                <div class="member-img d-flex justify-content-center">
                    <h2><?php if(empty($value[$x]['sp_count'])) { echo '0'; } else { echo $value[$x]['sp_count']; }  ?></h2>
                    
                </div>
                <div class="member-info">
                    <h4><?php if(empty($value[$x]['sp_name'])) { echo 'Test'; } else { echo ucfirst($value[$x]['sp_name']); }  ?> </h4>
                    ...
                    <div class="d-grid gap-1">
                        ...
                        <a href="<?= site_url('PMS/pDynamicColumn/'.$value[$x]['sp_projectid'].'/'.$value[$x]['sp_checklist_id']); ?>" class="btn btn-outline-dark"><i class="bx bx-plus"></i> Add Observations</a>
                        <div class="row justify-content-center">
                        <div class="col-md-6">
                            <a href="<?= site_url('PMS/editChecklist/'.$value[$x]['sp_checklist_id']); ?>" class="btn btn-outline-dark" style="width: 108%"><i class="bx bx-pencil"></i>Edit </a>
                        </div>
                        <div class="col-md-6">
            <a href="<?= site_url('PMS/Cdelete/'.$value[$x]['sp_checklist_id'].'/'.$value[$x]['sp_projectid']); ?>" class="btn btn-outline-dark" style="width: 100%" onclick="return confirm('Are you sure you want to delete this item?');"><i class="bx bx-trash"></i> Delete  </a>
                        </div>
                    </div>
                    </div>
                </div>
            ...
            <div class="modal-body p-0">
               ...
               <div class="col-md-12 col-lg-6 checklist-block-left" id="captureChecklistMap">                </div>
                    <div class="col-md-12 col-lg-6 py-5 px-5">
                        <form id="addChecklistForm1" action="<?= site_url('PMS/ProjChecklistAction')?>" method="post" enctype="multipart/form-data">
                            <div class="mb-4">
                                <h2 class="text-800">Add Projcect Checklist</h2>
