...
const getPlaygroundSharableLinkURL = '<?= API_URL?>/Apis/getPlaygroundSharableLink';
const getSharedDatasetURL = '<?= API_URL?>/Apis/getSharedDataset';
const downloadDatasetURL = '<?= API_URL?>/Apis/downloadDataset';
...
<body>
  <input type="hidden" name="shareID" value="<?= $datavalue;?>">
  ...
  <div id="guestControlHorizontalPanel" class="guestControlPanelHorizontalClass">
    ...
    <div id="data-source-button" class="button-horizontal-class" data-bs-toggle="tooltip" data-bs-placement="left" title="Data sources"><i class="bi bi-pie-chart align-icons"></i></div>
    <div id="species-search-box" class="textbox-class">
	  ...
	  <div id="species-search-box-info" class="species-search-commonname-div">
		<label class="species-search-commonname-label"></label>
		<div id="socialMediaPanel" class="social-media-panel-class">
			<div id="socialMediaPanelTray" style="display: flex;">
				...
				<div id="shareLinkedInButton" class="tray-icon"><i class="bi bi-linkedin align-icons social-media-icon-linkedin"></i></div>
			</div>
		</div>
	  </div>
    </div>
  ...
  <div class="modal modal-bottom" id="dataPlaygroundSpeciesDetails" tabindex="-1">
