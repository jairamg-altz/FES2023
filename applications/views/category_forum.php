...
//print_r($getReply);
  ...
  <a href="<?= site_url('Visitors/profile/'.$value->user_uuid);?>" target="_blank();"><i class="fa fa-plus-circle" aria-hidden="true" style="position: absolute;margin-left: 10px;padding-top:16px;font-size: 20px;
    color: white;"></i><img class="avatar" style="height:52px;width: 52px;" src="<?php if(!empty($value->profileimage_id)) { echo base_url('assets/uploads/'.$value->profileimage_id); } else 
...
<div class="col-md-4"><span class="col-md-4 heart"><i class="fa fa-heart-o" style="font-size:24px;"></i></span><span class="col-md-9 another-element" id="shareBtn"><i class="fa fa-share-alt" style="font-size:24px;" data-bs-toggle="modal" data-bs-target="#exampleModal"></i></span>
</div>
</div>
<div class="col-md-12">
...
<div class="col-md-12 container-fluid">
 ...
 if($getMediaRows->discussions_media_type=='image') {
  ?>   
    ...
    <img src="<?php if(!empty($getMediaRows->discussion_media_url)) { echo base_url('assets/img/forum/fmedia/'.$getMediaRows->discussion_media); } else { echo base_url('assets/uploads/Banner_02.jpg'); } ?>" style="width:520px;height: 210;border-radius: 8px;" class="img-fluid img-responsive">
    </div>
 <?php } elseif($getMediaRows->discussions_media_type=='video' || $getMediaRows->discussions_media_type=='audio') { ?>
<div class="col-md-6 card-body">  
<video  class="img-fluid rounded" controls>
<source src=<?php if(!empty($getMediaRows->discussion_media_url)) { echo base_url('assets/img/forum/fmedia/'.$getMediaRows->discussion_media); } else { echo base_url('assets/uploads/Banner_02.jpg'); } ?> type=video/mp4>
</video>
</div>
 <?php } } ?>   
</div>
...
<div class="container mt-2" >
  <div class="media border p-3">
    <a href="<?= site_url('Visitors/profile/'.$getReplyRows->user_uuid);?>"><img src="<?php if(!empty($getReplyRows->profileimage_id)) { echo base_url('assets/uploads/' . $getReplyRows->profileimage_id); } ?>" alt="<?= $getReplyRows->profileimage_id;?>" class="mr-3 mt-3 avatar" style="width:60px;"></a>
...
<div class="col-md-4 container-fluid">     
  <div class="col-md-12 ml-3 p-3 FHText"><b>MOST REPLIED POSTS</b></div> 
     ...
     <span><img class="avatarF" src="<?= IMAGE_URL.'06homepost-logindesktop-img-0981BB34-9E59-49F3-880E-43C6ACB6DFE8@2x.png'?>"></span> 
       ...
       <span style="padding-top:30px;position: absolute;margin-left: 20px;"><img src="<?= base_url('assets/uploads/Banner_02.jpg');?>" style="width:90px;height: 50px;border-radius: 8;"></span>
    </div><hr> -->
...
<?php } else {  ?>
<div class="col-md-12"> 
 <div class="card-body text-center"><h4><b>Record not found</b></h4></div>
 </div>
<?php } ?>
