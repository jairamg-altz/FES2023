...
<section class="p-0">
    <div class="col-md-60 page-header">
        <div class="profile-header-details">
            <div class="profile-header-details-img">
                <?php if (!empty($profileData->profileimage_id)) {?>
                    <img src="<?= IMAGE_URL.'../uploads/' . $profileData->profileimage_id; ?>" alt="Profile">
                <?php } else { ?>
                    <img src="<?= IMAGE_URL.'users/profile.png'; ?>" alt="Profile">
                <?php } $NlPoints = $getWatcherR - $totalReward; ?>
            </div>
            <div class="profile-header-details-desc">
                <div class="desc-1" style="width:100%">
                    <h3>
                        <?= (isset($_SESSION[SESSION_NAME]['name']) && !empty($_SESSION[SESSION_NAME]['name'])) ? ucfirst($_SESSION[SESSION_NAME]['name']) : ''; ?>
                    ...
                    <p class="d-none d-md-block" style="width:100%;text-align: justify;">
                ...
                <div class="desc-2" style="width:20%">
                    <div class="desc-2-top" style="float:right;padding-left:40px;">
 ...
 Following</button>
                    ...
                    <div class="desc-2 container-fluid">
                        <span class="h5text" style="padding-bottom:70px;padding-top: 10px;">0 Followers</span>
                    </div>
                </div>
            </div>
        </div>
...
<?php //print_r();exit;?>    
    <div class="profile-nav-tabs">
        <ul class="nav nav-tabs justify-content-around">
            <li class="nav-item">
                <button class="nav-link active" data-bs-toggle="tab" data-bs-target="#personal_ref">
                    <i class="bx bx-user h5text"></i>
                    <span class="h5text">
                        Personal Details
                    </span>
                </button>
            ...
            <li class="nav-item">
                <button class="nav-link" data-bs-toggle="tab" data-bs-target="#map_ref" onclick="initProfileMap();">
                    <i class="bi bi-map h5text"></i>
                    <span class="h5text" data-bs-toggle="modal" data-bs-target="#obserModal">
            ...
            <li class="nav-item">
                <button class="nav-link" data-bs-toggle="tab" data-bs-target="#identify_ref">
                    <i class="bi bi-globe2 h5text"></i>
                    <span class="h5text" data-bs-toggle="modal" data-bs-target="#IdentifiedModal">
                        Identified (<?= count($obIde);?>)
                    </span>
                </button>
            </li>
            <li class="nav-item">
                <button class="nav-link" data-bs-toggle="tab" data-bs-target="#posts_ref">
                    <i class="bi bi-pencil h5text"></i>
                    <a href="<?= site_url('Forum/myPost');?>"><span class="h5text">
                        Posts (<?= count($forum);?>)
                    </span></a>
                </button>
            </li>
            <li class="nav-item">
                <button class="nav-link" data-bs-toggle="tab" data-bs-target="#comments_ref">
                    <i class="bx bx-comment-detail h5text"></i>
                    <a href="<?= site_url('Forum/myPost');?>"><span class="h5text">
                        Comments (<?= count($forum);?>)
                    </span></a>
                </button>
            </li>
            <li class="nav-item">
    ...
    <div class="tab-content">
        <div class="container-fluid tab-pane" id="map_ref">
            <div id="map" class="map"></div>
            <div id="userProfileStatistics" class="row justify-content-center position-relative">

            </div>
        </div>
        <div class="container tab-pane active" id="personal_ref">
            <form action="<?= site_url('profile/update_profile_action') ?>" method="post" enctype="multipart/form-data">
                <div class="row d-none" id="edit_profile">
                   ...
                   <input type="hidden" name="user_uuid" value="<?= $profileData->user_uuid;?>">
                    <div class="col-md-4 mt-4">
                    ...
                    <!-- <div class="col-md-4 mt-4">
                        <label for="profile_user_id">User ID <span class="text-danger">*</span></label>
                        <input type="text" name="user_id" id="profile_user_id" class="form-control" placeholder="User ID" value="<?= (!empty($profileData->user_id)) ? $profileData->user_id : "" ?>">
                        <span class="input_error_message" id="profile_user_id_error"></span>
                    </div> -->
                    <div class="col-md-4 mt-4">
                        <label for="profile_title">Title</label>
                        <input type="text" name="title" id="profile_title" class="form-control" placeholder="Titile" value="<?= (!empty($profileData->title)) ? $profileData->title : "" ?>">
                    </div>
                    <div class="col-md-4 mt-4">
                    ...
                    <div class="col-md-4 mt-4">
                        ...
                        <input type="text" name="mobile_number" id="profile_mobile" class="form-control" placeholder="Mobile" value="<?php if(!empty($profileData->mobile_number)) { echo $profileData->mobile_number; }?>" maxlength="10" pattern="[789][0-9]{9}">
                    ...
                    <div class="col-md-12 mt-4">
                        <button type="submit" class="btn btn-primary">Update Profile <img src="<?= IMAGE_URL.'../svg/bars.svg'; ?>" alt="loader" class="loader"></button>
                    </div>
                </div>
            </form>
        ...
        <td>
            ...
            <td <?php if($getObserverR > $totalReward) { echo $Acc; }?>><img   src="<?= IMAGE_URL.'reward.png';?>" style="width: 90px"><br>Observer <br><b>↑</b></td>
    ...
    <tr>
        <td>
            <td></td> 
            <td <?php if($getAvid_WatcherR > $totalReward) { echo $Acc; }?>><img  src="<?= IMAGE_URL.'reward.png';?>" style="width: 90px"> <br> Avid watcher<br><b>↑</b></td>
            <td <?php if($getCommunity_ChampionR > $totalReward) { echo $Acc; }?>><img  src="<?= IMAGE_URL.'reward.png';?>" style="width: 90px"> <br> Community champian<br>↑</td>
            <td></td>
            <td></td>       
    </tr>
        <td>
            <blockquote>               
            <td <?php if($getNoviceR > $totalReward) { echo $Acc; }?>><img  src="<?= IMAGE_URL.'reward.png';?>" style="width: 90px"><br>Novice</td>
             </blockquote>
            <td <?php if($getWatcherR > $totalReward) { echo $Acc; }?>><img  src="<?= IMAGE_URL.'reward.png';?>" style="width: 90px"><br>Watcher</td>
            <td <?php if($getCommunity_ParticipantR > $totalReward) { echo $Acc; }?>><img  src="<?= IMAGE_URL.'reward.png';?>" style="width: 90px"><br>Community partcipate </td>
            <td <?php if($getContributorR > $totalReward) { echo $Acc; }?>><img  src="<?= IMAGE_URL.'reward.png';?>" style="width: 90px"><br>Contributor</td>
            <td <?php if($getResearcherR > $totalReward) { echo $Acc; }?>><img  src="<?= IMAGE_URL.'reward.png';?>" style="width: 90px"><br> Researcher</td>
            <td <?php if($getExpertR > $totalReward) { echo $Acc; }?>><img  src="<?= IMAGE_URL.'reward.png';?>" style="width: 90px"><br>Expert</td>
        </td>
    </table>
...
<!-- Modal -->
<div class="modal fade" id="obserModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" style="overflow-y: auto;max-height:85vh;overflow-x: hidden;">
        <table id="exampleobj" class="table table-striped" style="width:100%;">
        <thead>
            <tr>
                <th>SrNo</th>
        ...
        <tbody>
    <?php $srNo=1; foreach($getobj as $observationRow) { //print_r($observationRow);
     ?>
         <tr>
                 <td><?= $srNo; ?></td>
                <td><?= $observationRow->scientific_name; ?></td>
                <td><?= $observationRow->recorded_by; ?></td>
                <td><?= $observationRow->individual_count; ?></td>
                <td><?= $observationRow->observation_type; ?></td>
                </tr>
        <?php $srNo++;} ?>    
         </tbody>
         </table>   
...
<div class="modal fade" id="IdentifiedModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Identified</h5>
        <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body" style="overflow-y: auto;max-height:85vh;overflow-x: hidden;">
        <table id="exampleobjD" class="table table-striped" style="width:100%;">
        <thead>
            <tr>
                <th>SrNo</th>
                <th>Scientific Name</th>
        ...
        <tbody>
    <?php $srNo=1; foreach($getid as $observationRow) { //print_r($observationRow);
     ?>
         <tr>
                 <td><?= $srNo; ?></td>
                <td><?= $observationRow->scientific_name; ?></td>
...
<script type="text/javascript">
 $(document).ready(function () {
    $('#exampleobj').DataTable();
    });
 $(document).ready(function () {
    $('#exampleobjD').DataTable();
}); 
</script>