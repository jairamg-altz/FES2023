...
$config['facebook_app_id']              = '396848892374979';
$config['facebook_app_secret']          = '0b8773ed0abc012f0e70ddfc02a7aac1';
$config['facebook_login_type']          = 'web';
$config['facebook_login_redirect_url']  = 'index.php/Login/fblogin';
$config['facebook_logout_redirect_url'] = 'index.php/home/logout';
$config['facebook_permissions']         = array('email');
$config['facebook_graph_version']       = 'v14.0';
